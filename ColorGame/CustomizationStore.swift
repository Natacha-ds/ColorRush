...
class CustomizationStore: ObservableObject {
  ...
  @Published var isLevelSystemEnabled: Bool =
    true // Always enabled - new system only
  ...
  private func loadLevelSystemEnabled() -> Bool {
    userDefaults.bool(forKey: levelSystemEnabledKey)
  }
  ...
  func getEasyDuration() -> Int {
    customization.easySettings.durationSeconds
  }
  ...
  func getNormalRoundTimeout() -> Double {
    customization.normalSettings.roundTimeoutSeconds
  }

  func getNormalMaxMistakes() -> Int {
    customization.normalSettings.maxMistakes
  }
  ...
  func getHardConfusionSpeed() -> Double {
    customization.hardSettings.confusionSpeedSeconds
  }

  func getHardMaxMistakes() -> Int {
    customization.hardSettings.maxMistakes
  }
